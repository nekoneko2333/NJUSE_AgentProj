...
ROLE_POLICY = {
    AgentRole.SINGLE: {"tools": {"list_files", "read_file", "search_text", "write_file", "replace_text", "run_command"}, "goal": "独立完成分析、实现与验证，给出一个完整结论。"},
    ...
    AgentRole.CODER: {"tools": {"list_files", "read_file", "search_text", "write_file", "replace_text", "run_command"}, "goal": "实现改动并运行验证。"},
